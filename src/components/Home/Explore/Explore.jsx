...
export const Explore = () => {
    ...
    const cards = [
        ...
        { id:1, title:'Ethereum for enterprise', paragraph:'See how Ethereum can open up new business models, reduce your costs and future-proof your business.', image:'Infrastructure2Image'},
